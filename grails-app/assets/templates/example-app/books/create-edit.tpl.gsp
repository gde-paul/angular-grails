...
<form name="form" class="form-horizontal" role="form" novalidate>
    <f:with bean="${new Book()}">
        ...
        <f:field property="author" input-ng-model="item.author" input-ng-options="author as author.firstName + ' ' + author.lastName for author in authors track by author.id"  />
